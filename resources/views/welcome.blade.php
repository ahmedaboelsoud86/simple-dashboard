                                ...
                                <div class="card overflow-hidden mb-4">
                                    <div class="card-body p-4">
                                        ...
                                        <div class="card-subtitle text-body-secondary"><span
                                                ...
                                                data-coreui-i18n-date-format="{ 'month': 'long' }">January</span>&nbsp;-
                                            <span data-coreui-i18n-date="date, { 'date': '2023, 6, 1'}"
                                                data-coreui-i18n-date-format="{ 'year': 'numeric', 'month': 'long' }">July
                                                2023</span>
                                        </div>
                                    </div>
                        ...
                        <div class="card mb-4">
                            <div class="card-body p-4">
                                ...
                                <div class="card-subtitle text-body-secondary"><span
                                        ...
                                        01, 2022</span>&nbsp;-&nbsp;<span
                                        data-coreui-i18n-date="date, { 'date': '2022, 12, 31'}"
                                        data-coreui-i18n-date-format="{ 'year': 'numeric', 'month': 'long', 'day': 'numeric' }">December
                                        31, 2022</span></div>
